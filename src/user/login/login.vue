                ...
                <div class="wrap-login100">
					...
					<span class="login100-form-title p-b-26">
                        ...
                        <div class="wrap-input100 validate-input" data-validate="Valid email is: a@b.c">
                            <input class="input100" type="text" name="email" v-model="form.username">
						...
						<span class="btn-show-pass">
                            ...
                            <input class="input100" type="password" name="pass" v-model="form.password">
                        ...
                        <div class="container-login100-form-btn">
                            <div class="wrap-login100-form-btn">
                                ...
                                <button class="login100-form-btn" type='button' @click="loginUser">
                                    Login
                                </button>
                            </div>
                        </div>
  ...
  export default {
    ...
    methods: {
      ...
      loginUser() {
        ...
        console.log(this.login(this.form).then((status) => {
          if (status === 422) {
            this.$notify({
              group: 'foo',
              type: 'error',
