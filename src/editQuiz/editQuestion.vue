                            ...
                            <div class="panel panel-warning">
                                ...
                                <div class="panel-body">
                                    <div v-for='index in countOfAnswers' :key='index' id="d">
                                            <editAnswer :count="countOfAnswers"
                                                        :countOfQuestion="countOfQuestion"
                                                        v-on:input='counter'
                                                        :arrayOfQuestions='arrayOfQuestions'
                                                        :answerName="arrayOfQuestions[indexOfQuestions-1].answers[index-1].name"
                                                        :isTrue="arrayOfQuestions[indexOfQuestions-1].answers[index-1].isTrue"
                                                        :index="index"
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                countOfAnswers: this.answerCount,
